          ...
          if (installingWorker.state === "installed") {
           ...
           // doPushSubscribe(registration);
            ...
            if (navigator.serviceWorker.controller) {
              ...
              alert(
                "A newer version is available! Please close the window to update."
              );
...
function doPushSubscribe( registration){
  /**
   *
   * CUSTOM PUSH SUBSCRIBE
   */
  const pubKey =
...
//WHY FETCH AFTER ALL?
      // fetch("https://www.volatalk.org/subscribe", {
      //   method: "POST",
